...
<template>
  <div class="min-h-screen bg-dark-950 flex flex-col justify-center items-center relative overflow-hidden font-sans">
    ...
    <main class="w-full max-w-md px-6 py-12 relative z-10">
      <!-- Logo/Brand (Optional placeholder, adapt to actual logo later) -->
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div class="space-y-2">
            <div class="flex items-center justify-between">
              ...
              <a href="#" class="text-xs font-medium text-primary-400 hover:text-primary-300 transition-colors">
                Lupa password?
              </a>
            </div>
            <div class="relative group">
          ...
          <button 
            type="submit" 
            class="w-full bg-primary-500 hover:bg-primary-600 text-white font-medium py-3 px-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-primary-500/25 flex justify-center items-center gap-2"
          >
            <span>Masuk</span>
