  ...
  <div class="ts-login-root min-h-screen bg-dark-950 text-ink-0 font-sans flex flex-col justify-between items-center relative overflow-x-hidden selection:bg-primary-500 selection:text-dark-950">
    ...
    <main class="w-full max-w-[440px] px-4 sm:px-6 py-8 relative z-10 my-auto">
      ...
      <div class="ts-login-hero text-center mb-8">
        ...
        <p class="text-ink-1 mt-2 text-sm max-w-[32ch] mx-auto leading-relaxed">
          ...
          <div class="space-y-1.5">
            ...
            <div class="relative group">
              ...
              <input
                ...
                class="w-full bg-dark-950 border border-white/10 hover:border-white/20 text-ink-0 text-sm rounded-xl pl-10 pr-11 py-3 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500/50 transition-all placeholder:text-ink-3 font-sans"
              />
              <button
                type="button"
