    ...
    <main class="w-full max-w-[1000px] my-auto relative z-10">
      <div class="ts-auth-split-card bg-dark-900/90 backdrop-blur-2xl border border-white/10 rounded-3xl p-3 sm:p-4 lg:p-5 shadow-2xl relative grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
        ...
        <div class="ts-auth-left hidden lg:flex lg:col-span-5 rounded-[22px] p-7 flex-col justify-between relative overflow-hidden text-ink-0 border border-white/10 shadow-inner">
          ...
          <div class="my-auto py-8 relative z-10 flex flex-col items-center justify-center">
            <div class="relative flex items-center justify-center gap-3">
              <div class="w-16 h-16 rounded-2xl bg-dark-900/90 backdrop-blur-xl border border-white/10 flex items-center justify-center shadow-xl transform -rotate-6">
                <span class="text-2xl font-sans font-semibold text-ink-1">تِ</span>
              </div>
              <div class="w-20 h-20 rounded-2xl bg-dark-900/95 backdrop-blur-2xl border border-primary-500/30 flex items-center justify-center shadow-2xl transform scale-110 z-10">
                <span class="text-3xl font-sans font-semibold text-primary-400">بَ</span>
              </div>
              <div class="w-16 h-16 rounded-2xl bg-dark-900/90 backdrop-blur-xl border border-white/10 flex items-center justify-center shadow-xl transform rotate-6">
                <span class="text-2xl font-sans font-semibold text-ink-1">ثُ</span>
              </div>
            </div>
          </div>
          ...
          <div class="relative z-10 space-y-2">
            ...
            <h2 class="font-display font-semibold text-xl leading-snug text-ink-0">
              Latihan mandiri kapan saja dengan analisis pelafalan yang <em class="font-serif italic text-primary-400 font-normal">akurat.</em>
            </h2>
            <p class="text-xs text-ink-2 font-sans leading-relaxed">
              Gratis sepenuhnya, dapat diakses langsung tanpa instalasi aplikasi.
            </p>
          </div>
        </div>
        ...
        <div class="ts-auth-right lg:col-span-7 p-4 sm:p-6 lg:p-8 flex flex-col justify-center">
          ...
          <div class="flex lg:hidden items-center justify-between mb-5 pb-3.5 border-b border-white/5">
          ...
          <form @submit.prevent="handleRegister" class="space-y-3.5">
            ...
            <div class="space-y-1">
              ...
              <div class="relative group">
                ...
                <input
                  ...
                  autocomplete="name"
                  class="w-full bg-dark-950 border border-white/10 hover:border-white/20 text-ink-0 text-sm rounded-xl pl-10 pr-4 py-2.5 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500/50 transition-all placeholder:text-ink-3 font-sans"
                />
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div class="space-y-1">
                ...
                <div class="relative group">
                  <input
                    ...
                    class="w-full bg-dark-950 border border-white/10 hover:border-white/20 text-ink-0 text-sm rounded-xl pl-3.5 pr-10 py-2.5 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500/50 transition-all placeholder:text-ink-3 font-sans"
                  />
                  <button
                    type="button"
                    @click="showPass = !showPass"
                    class="absolute inset-y-0 right-0 pr-3 flex items-center text-ink-3 hover:text-ink-1 transition-colors"
              ...
              <!-- Confirm Password -->
              <div class="space-y-1">
                <label class="block font-mono text-xs uppercase tracking-wider text-ink-2">Konfirmasi</label>
                <div class="relative group">
                  <input
                    ...
                    autocomplete="new-password"
                    class="w-full bg-dark-950 border text-ink-0 text-sm rounded-xl pl-3.5 pr-10 py-2.5 focus:outline-none transition-all placeholder:text-ink-3 font-sans"
            ...
            <p v-if="confirmPassword && confirmPassword !== password" class="font-mono text-[11px] text-rose-400">
